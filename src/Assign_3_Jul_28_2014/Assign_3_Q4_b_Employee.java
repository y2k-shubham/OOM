...
class Employee_Q4_b extends Assign_3_Q4_Person {
    ...
    public Employee_Q4_b(String name, String bloodGroup, String dateOfBirth, String address, String city, int pinCode, long phoneNo, float salary) {
    ...
    public static void main(String args[]) {
        ...
        obj = new Employee_Q4_b(name, bloodGroup, dateOfBirth, address, city, pinCode, phoneNo, salary);

        ps.println("\nThe details of the Employee are:-");
        ps.println("Name:\t\t" + obj.name);
        ps.println("Blood Group:\t" + obj.bloodGroup);
        ps.println("Date Of Birth:\t" + obj.dateOfBirth);
