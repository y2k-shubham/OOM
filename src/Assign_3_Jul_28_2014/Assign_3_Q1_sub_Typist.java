...
class Typist extends Employee_Q1 {
    ...
    public Typist(float Basic_pay, String Emp_code, String Emp_name, String Address, String Ph_no) {
    ...
    public static void main(String args[]) {
        ...
        ps.println("Enter the details of the Typist:-");
        ...
        obj = new Typist(Basic_pay, Emp_code, Emp_name, Address, Ph_no);

        ps.println("\nThe details of the Typist are:-");
